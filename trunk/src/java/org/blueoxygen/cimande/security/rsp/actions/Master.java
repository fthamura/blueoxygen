...
public class Master extends CimandeAction {
	...
	public String execute() {
		if (getRole().getId() != null
			...
			setRoleSites(manager.getList("FROM " + RoleSite.class.getName()
		...
		if (getRoleSite().getId() != null
			...
			setRoleSite((RoleSite) manager.getById(RoleSite.class,
					getRoleSite().getId()));
			setRsps(manager.getList("FROM " + RoleSitePrivilage.class.getName()
