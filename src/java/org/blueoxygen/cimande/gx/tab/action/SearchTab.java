...
public class SearchTab extends TabForm implements HibernateSessionFactoryAware {
	...
	public String execute() {
		...
		Criteria crit = sess.createCriteria(Tab.class);
		...
		if (!column.getWindow_id().equalsIgnoreCase("")){
			crit.add(Expression.like("window_id", "%"+tab.getWindow_id()+"%"));
		}*/
		...
		tabs = crit.addOrder(Order.asc(orderBy))
