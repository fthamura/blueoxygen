...
public class SearchColumn extends ColumnForm implements HibernateSessionFactoryAware {
	...
	public String execute() {
		...
		Criteria crit = sess.createCriteria(DBColumn.class);
		...
		columns = crit.addOrder(Order.asc(orderBy))
