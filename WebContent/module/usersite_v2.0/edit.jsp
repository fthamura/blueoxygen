...
<table bgcolor="black" border="0" cellpadding="3" cellspacing="1" width="98%"><tr bgcolor="#ffffff" valign="top" > 
	<td bgcolor="#ffccff"><b>Backend User</td></tr>
    <tr bgcolor="#ffffff" valign="top"><td>
   		<form name="backend_user" action="act_index.jsp?code=edit" method="post">
 			 <table bgcolor="black" border="0" cellpadding="3" cellspacing="1" width="100%">
  				<tr bgcolor="#ffffff" valign="top"><td bgcolor="#D0DCFF" colspan="3"><b>Edit Master</td></tr>
				<tr bgcolor="#ffffff" valign="top"><td width="25%"><div align="right"><font color="red"></font>ID: 
					...
					<input type="hidden" name="site_id"  size="28" value="<%=myResultSet.getString("backend_user.site_id") %>">
					<input type="hidden" name="id"  size="28" value="<%=myResultSet.getString("backend_user.id") %>"></td><td>&nbsp;</td></tr>
				<tr bgcolor="#ffffff" valign="top"><td width="25%"><div align="right"><font color="red">* </font>Login: 
					</div></td><td><input maxlength="128" name="username" size="15" type="text" value="<%=myResultSet.getString("backend_user.username") %>"></td><td>&nbsp;</td></tr>
	
				<tr bgcolor="#ffffff" valign="top"><td width="25%"><div align="right"><font color="red">* </font>Password: 
					</div></td><td><input maxlength="30" name="password" size="15" type="password" value="<%=pass %>"></td><td>&nbsp;</td></tr>

				<tr bgcolor="#ffffff" valign="top"><td width="25%"><div align="right"><font color="red">* </font>First Name: 
					</div></td><td><input maxlength="128" name="first_name" size="15" type="text" value="<%=myResultSet.getString("backend_user.first_name") %>"></td><td>&nbsp;</td></tr>

				<tr bgcolor="#ffffff" valign="top"><td width="25%"><div align="right"><font color="red"></font>Last Name: 
					</div></td><td><input maxlength="128" name="last_name" size="15" type="text" value="<%=myResultSet.getString("backend_user.last_name") %>"></td><td>&nbsp;</td></tr>

				<tr bgcolor="#ffffff" valign="top"><td width="25%"><div align="right"><font color="red">*</font>Company: 
					</div></td><td><input maxlength="28" name="company_id" size="35" type="hidden" value="<%=myResultSet.getString("backend_user.company_id") %>">
					<input maxlength="128" name="company_name" size="35" type="text" value="<%=myResultSet.getString("company.name") %>" readonly>
					&nbsp;&nbsp;<input type="button"  value="View Company" onclick="GoAddressCompany();"></td><td>&nbsp;</td></tr>

				<tr bgcolor="#ffffff" valign="top"><td width="25%"><div align="right"><font color="red">* </font>Position: 
					</div></td><td><input maxlength="28" name="position_id" size="35" type="hidden" value="<%=myResultSet.getString("backend_user.job_position_id") %>">
					<input maxlength="128" name="position_name" size="35" type="text" value="<%=myResultSet.getString("job_position.name") %>" readonly>
					&nbsp;&nbsp;<input type="button"  value="View Position" onclick="GoAddressPosition();"></td><td>&nbsp;</td></tr>

				<tr bgcolor="#ffffff" valign="top"><td width="25%"><div align="right"><font color="red"></font>Email: 
					</div></td><td><input maxlength="125" name="email" size="25" type="text" value="<%=myResultSet.getString("backend_user.email") %>"></td><td>&nbsp;</td></tr>

				<tr bgcolor="#ffffff" valign="top"><td width="25%"><div align="right"><font color="red"></font>Address: 
					</div></td><td><input maxlength="255" name="address1" size="35" type="text" value="<%=myResultSet.getString("backend_user.address1") %>"></td><td>&nbsp;</td></tr>

				<tr bgcolor="#ffffff" valign="top"><td width="25%"><div align="right"><font color="red"></font>: 
					</div></td><td><input maxlength="255" name="address2" size="35" type="text" value="<%=myResultSet.getString("backend_user.address2") %>"></td><td>&nbsp;</td></tr>

				<tr bgcolor="#ffffff" valign="top"><td width="25%"><div align="right"><font color="red"></font>City: 
					</div></td><td><input maxlength="128" name="city" size="15" type="text" value="<%=myResultSet.getString("backend_user.city") %>"></td><td>&nbsp;</td></tr>

				<tr bgcolor="#ffffff" valign="top"><td width="25%"><div align="right"><font color="red"></font>Description:
						</div></td><td valign="top"><textarea cols="35" name="description" rows="5"><%=myResultSet.getString("backend_user.description") %></textarea></td><td>&nbsp;</td></tr>
				...
				<tr bgcolor="#ffffff" valign="top"><td width="25%"><div align="right"><font color="red"></font>Calendar:
						...
						<%
								} else { if (myResultSet.getString("backend_user.calendar_flag").equalsIgnoreCase("0")) {
						%>
				...
				<tr bgcolor="#ffffff" valign="top"><td width="25%"><div align="right"><font color="red"></font>Project:
						...
						<%
								} else { if (myResultSet.getString("backend_user.project_flag").equalsIgnoreCase("0")) {
						%>
				...
				<tr bgcolor="#ffffff" valign="top"><td width="25%"><div align="right"><font color="red"></font>Active:
						...
						<%
								if (myResultSet.getString("backend_user.active_flag").equalsIgnoreCase("1"))
								{
						%>
								<input name="active_flag" type="radio" value="1" checked>Yes<br>
								<input name="active_flag" type="radio" value="0">No<br>
						<%
								} else { if (myResultSet.getString("backend_user.active_flag").equalsIgnoreCase("0")) {
						%>
				...
				<tr bgcolor="#ffffff" valign="top"><td align="right" width="25%">&nbsp;</td>
						<td colspan="2"><input name="submit" onclick="return checkfields(this);" type="submit" value="Next &gt;&gt;"></td></tr>
			</table></form>
	</table></td></tr></table>
<%
}
