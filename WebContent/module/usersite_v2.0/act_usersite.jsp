...
if (objexist==false) {
	response.sendRedirect("usersite.jsp?act=add&code="+temp);				//object berhasil ditambahkan.
} else {
	response.sendRedirect("usersite.jsp?act=add&strExst=true&code="+temp);		//object udah ada, kasih warning ke user.
}
%>
