...
public class RolePrivilageMapper {
	...
	public RolePrivilageMapper(String sRoleSiteId)  throws SQLException, Exception{
		...
		mySQL = "SELECT DISTINCT module_function_id FROM role_privilage WHERE role_site_id='"+ sRoleSiteId +"'";// AND rsite_id='"+sSiteId+"'";
