...
<form method="post" action="search_r.jsp">
    ...
    <tr bgcolor="#ffffff"> 
      ...
      <td> 
        ...
        <input maxlength="128" name="name" size="25" type="text" value>
      </td>
    ...
    <td>
        ...
        <input  name="skin_id" maxlength="28" size="28" type="text" value>
        </td>
     
    </tr>
    <tr bgcolor="#ffffff" valign="top"><td width="25%"><div align="right">Status:
						</div></td><td>
        <input type="hidden" name="ArtStatusCon" value="and">						
