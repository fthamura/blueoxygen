...
<tr bgcolor="#ffffff" valign="top"><td align="right" width="25%">
										&nbsp;
									</td><td colspan="2"><input name="submit" onclick="return checkfields(this);" type="submit" value="next &gt;&gt;"></td></tr></table></form></body></html>
