...
mySQL = "select * from template order by name";
...
<!--
	...
	{
		window.opener.document.frmfirst.template_id.value = var1; 
		window.opener.document.frmfirst.template_name.value = var2; 
		window.close();
	}
-->
</script>
