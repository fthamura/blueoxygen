<form name="frmForm" method="post" action="act_usersite.jsp?act=add&code=<%= code %>">
  <table bgcolor="black" border="0" cellpadding="3" cellspacing="1" width="100%">
    ...
    <td colspan="2"><font color="ff0000">*</font> required <br><div align="right"><input type="submit" value=" Add User Site " onclick="ceksubmit(); return false;"></div></td></tr>
  </table>
</form>
